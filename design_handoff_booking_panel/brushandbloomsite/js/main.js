...
(function () {
  ...
  var translations = {
    fr: {
      ...
      "home.meta.guests": "Invités accueillis",
    ...
    nl: {
      ...
      "home.meta.guests": "Verwelkomde gasten",
  ...
  function initContactForm() {
    ...
    form.addEventListener("submit", function (e) {
      ...
      if (note) {
        note.textContent = "Thanks! This form isn't wired up to an inbox yet — see README-CONTENT-TODO.md to connect it (e.g. Formspree, Netlify Forms, or a mailto link).";
